# 2023/3/28
# This script fine-tune the saved Informer on a specific condition or cell.
# Author: Ruifeng Tan
...
def main():
    fitlog.set_log_dir("./meta_logs/")
    parser = argparse.ArgumentParser(description='Autoformer & Transformer family for Time Series Forecasting')

    # basic config
    parser.add_argument('--is_training', type=int, default=1, help='status')
    parser.add_argument('--model_id', type=str, default='NCA', help='model id')
    parser.add_argument('--model', type=str, default='Informer',
                        help='model name, options: [Autoformer, Informer, Transformer, PIInformer, OneShotLSTM]')

    # data loader
    parser.add_argument('--data', type=str, default='Batteries_cycle_SLMove', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./dataset/NC_NCA_autoformer_cycle_data/',
    ...
    # optimization
    parser.add_argument('--FT', action='store_true', default=True, help='Set True to start fine-tune')
    parser.add_argument('--K', type=int, default=3, help='cluster number for K-means')
    parser.add_argument('--knee_percent', type=int, default=0.25, help='empirically the data percent of a cell behind the knee')
    parser.add_argument('--clustering_threshold', type=int, default=50, help='cluster thresold used in K-means')
    parser.add_argument('--val_ratio', type=float, default=0.33, help='the ratio of validation data in the training set')
    ...
    parser.add_argument('--FT_learning_rate', type=float, default=5e-4, help='optimizer learning rate')
    parser.add_argument('--meta_learning_rate', type=float, default=0.005, help='meta optimizer learning rate')
    parser.add_argument('--meta_beta', type=float, default=2, help='weight of the test domain loss')
    parser.add_argument('--auxiliary_gamma', type=float, default=0.25, help='weight of the test domain loss')
    parser.add_argument('--meta_train', action='store_true', default=False, help='set True to use meta learning')
    ...
    parser.add_argument('--loss', type=str, default='wmse', help='loss function options:[mse,wmse]')
    parser.add_argument('--vali_loss', type=str, default='wr', help='loss function options:[w,nw]')
    ...
    parser.add_argument('--upper_V', type=float, default=3.6, help='the upper voltage')
    parser.add_argument('--lower_V', type=float, default=2.0, help='the cutoff voltage')
