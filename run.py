...
def main():
    ...
    parser.add_argument('--model', type=str, default='Informer',
                        help='model name, options: [Autoformer, Informer, Transformer, vLSTM, OneShotLSTM, OSLSTMv2]')
    ...
    # optimization
    parser.add_argument('--DA', action='store_true', default=True, help='Set True to start domain adapation')
    ...
    parser.add_argument('--wd', type=float, default=1e-4, help='weight decay in Adam')
    parser.add_argument('--itr', type=int, default=1, help='experiments times')
    parser.add_argument('--train_epochs', type=int, default=50, help='train epochs')
    parser.add_argument('--batch_size', type=int, default=32, help='batch size of train input data')
    parser.add_argument('--patience', type=int, default=3, help='early stopping patience')
    parser.add_argument('--learning_rate', type=float, default=0.005, help='optimizer learning rate') # meta
    parser.add_argument('--meta_learning_rate', type=float, default=0.005, help='meta optimizer learning rate') # meta
    parser.add_argument('--meta_beta', type=float, default=0.25, help='weight of the test domain loss')
